...
class UHC:
    ...
    def __init__(self, json):
        self.kit = checkJsonNullValue(eval(json), 'equippedKit')
        self.coins = checkJsonNullValue(eval(json), 'coins')
        self.deaths = checkJsonNullValue(eval(json), 'deaths')
        self.heads_eaten = checkJsonNullValue(eval(json), 'heads_eaten')
        ...
        self.ultimates_crafted = checkJsonNullValue(eval(json), 'ultimates_crafted')
